...
export default function GeburtenkalenderPage() {
  ...
  // Mini-Kalender für die Monate mit erwarteten Geburten
            ...
            {erwartet.map((k) => {
              ...
              return (
                <Link
                  key={k.nr}
                  href="/tiere"
                  className={`block rounded-xl border p-4 transition-colors ${urgent ? 'bg-amber-50 border-amber-200 hover:border-amber-400' : 'bg-stone-50 border-stone-200 hover:border-stone-300'}`}
                >
